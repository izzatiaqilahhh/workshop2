...
CREATE TABLE `room` (
  ...
  `Current_Occupants` int(11) NOT NULL CHECK (`Current_Occupants` <= `Capacity`),
...
INSERT INTO `student` VALUES (1,'B032210139','Nur Fathehah Binti Mohd Aris','B032210139@student.utem.edu.my','$2y$12$4ih1p3dYQKOXQ4nijFlEKuPqUYHTOE0QnMXVLugCe4hW80SFJRRMO','0199590828','Female','Database Management','FTMK',2,1),(2,'B032210137','Afifah Syaza Huda Binti Ahmad','B032210137@gmail.com','password','0186670909','Female','Database Management','FTMK',3,3),(3,'B032210135','Amiera Badriesya Binti Kamal','B032210135@gmail.com','password','0178863773','Female','Database Management','FTMK',3,3),(4,'B032210267','Nurin Hannah Binti Zamberi','B032210267@gmail.com','password','0162235567','Female','Database Management','FTMK',3,4),(5,'B032210166','Nur Aqila Nadzira Binti Shahlan','B032210166@gmail.com','password','0175685078','Female','Database Management','FTMK',3,4);
...
-- Dump completed on 2025-01-20 17:57:36
